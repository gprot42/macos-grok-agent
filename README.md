...
- **Grok Voice Transcribe 2.0** — Upload audio or video (WAV, MP3, OGG, Opus, FLAC, AAC, M4A, MP4, MKV, up to 500 MB) record a clip, or **transcribe live** as you speak (streaming, with interim results) and get the transcript: speaker labels (diarization), word-level timestamps, key-term biasing, number/date formatting, and export to `.txt` or `.srt` subtitles
