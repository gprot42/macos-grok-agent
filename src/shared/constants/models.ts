...
export const MODELS: Record<string, ModelConfig> = {
  ...
  "grok-imagine-video": {
    ...
    displayName: "Grok Imagine Video (Legacy)",
    maxInputTokens: 32768,
    maxOutputTokens: 8192,
    icon: "video",
    color: "#1DA1F2",
    description: "Text-to-video and image-to-video — 480p/720p, $0.05/sec",
  ...
  "grok-voice": {
    ...
    publisher: "xai",
    modelId: "grok-tts",
    displayName: "Grok Voice (TTS)",
    maxInputTokens: 32768,
    maxOutputTokens: 8192,
    icon: "mic",
    color: "#17BF63",
    description: "Text-to-speech — 27 voices, 20+ languages, $15 / 1M characters",
  ...
  "grok-voice-think-fast-2.0": {
    ...
    icon: "mic",
    color: "#0EA5E9",
    description: "Flagship real-time speech-to-speech agent — reasoning with zero added latency, tools, 20+ languages",
    // pricing.input ≈ text input $/1M tokens proxy; pricing.output = $ per audio minute
    pricing: { input: 0.004, output: 0.08 },
    supportsVoiceAgent: true,
    endpointSupport: ["xai"],
  },
  "grok-voice-think-fast-1.0": {
    ...
    icon: "mic",
    color: "#06B6D4",
    description: "Previous-generation real-time speech-to-speech agent",
    pricing: { input: 0.004, output: 0.05 },
    supportsVoiceAgent: true,
    endpointSupport: ["xai"],
  },
  "grok-voice-latest": {
    ...
    displayName: "Grok Voice (Latest)",
    maxInputTokens: 128000,
    maxOutputTokens: 32768,
    icon: "mic",
    color: "#38BDF8",
    description: "Alias that tracks the newest voice agent model (moves to Think Fast 2.0 on Aug 5, 2026)",
    pricing: { input: 0.004, output: 0.08 },
    supportsVoiceAgent: true,
    endpointSupport: ["xai"],
  },
